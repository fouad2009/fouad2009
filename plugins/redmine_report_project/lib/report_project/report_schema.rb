...
module ReportProject
  ...
  fh: 11,
  etude: 12,
  autorisation_voirie: 13,
  etablissement_contrat: 14,
  branchement_electrique: 15,
  permis_construction: 16,
  construction_abris: 17,
  amenagement_centres_techniques: 18,
  acquisition_pylone: 19,
  remplacement_fo: 20,
  acquisition: 21,
  depose_cable_zero: 22,
  odn_distribution: 23,
  raccordement_clients_ods: 24,
  cite_geomark: 25,
  cana_odn_distribution: 26,
  fo_odn_transport: 27,
  cana_odn_transport: 28,
  etude_fttx_aps: 29,
  reservation_fo: 30,
  socle_odn_fdt: 31,
  mod_olt_ftth: 32,
  pose_fo_uplink: 33,
  pose_fo_liaison_atm: 34,
  prolongement_adduction_cable: 35,
  socle_msan_fttx: 36,
  amenagement_nouveaux_abris: 37,
  plateforme_pylone: 38,
  undefined: 39,
  socle_4g: 40,
  basculement_reseau: 41,
  extension_olt: 42,
  normalisation_msan: 43,
  remise_en_etat: 45,
  materiel_4g_fh: 46,
  cite_dev: 47,
  extension_cable: 48,
  mod_odn_tdm: 49,
  dev_odn: 50,
  remplacement_msan_odn: 51,
  pose_fo_corporate: 52,
  reservation_fo_corporate: 53,
  pose_cable_corporate: 54,
  liaison_fo: 56,
  securisation_site: 57,
  cite_mod_msan: 58,
  cite_mod_tdm: 59,
  odn_prestation: 60,
  pose_cana_corporate: 61,
  raccordement_clients_dot: 62,
  liaison_fo_corporate: 63,
  pa_dev: 64,
  pa_mod: 65,
  besoin_odn_aps: 66,
  pa_fo: 67,
  acquisition_realisation: 68,
  bc_acquisition: 69,
  contrat_gre_a_gre: 70,
  bc_prestation: 71,
  negociation: 72
}.freeze
